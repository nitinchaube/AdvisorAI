      ...
      return (
        <div style={{ marginLeft: '1rem' }}>
          {value.map((item, index) => (
            <div key={index} style={{ marginBottom: '0.5rem', padding: '0.5rem', backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: '4px' }}>
              {typeof item === 'object' && item !== null ? (
                <div>
                  {Object.entries(item).map(([key, val]) => (
                    <div key={key} style={{ marginBottom: '0.25rem' }}>
                      <strong>{formatFieldName(key)}:</strong> {String(val || 'Not specified')}
                    </div>
                  ))}
                </div>
              ) : (
  ...
  if (loading) {
    return (
      <div style={{ 
        ...
        <Loader2 style={{ width: '3rem', height: '3rem', animation: 'spin 1s linear infinite' }} />
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1.5rem', marginBottom: '1.5rem' }}>
            <div style={{
              ...
              <User style={{ width: '2.5rem', height: '2.5rem', color: 'white' }} />
            </div>
            <div>
              <h1 style={{ fontSize: '3rem', fontWeight: '700', margin: '0', textShadow: '0 4px 8px rgba(0, 0, 0, 0.3)' }}>
                Profile Data
              </h1>
              <div style={{
                display: 'inline-flex',
        ...
        <div>
          {profileData && Object.keys(profileData).length > 0 ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              {Object.entries(profileData).map(([fieldName, fieldValue]) => (
                <div key={fieldName} style={{
                  ...
                  <div style={{ marginLeft: '3.5rem', color: 'rgba(255, 255, 255, 0.9)', lineHeight: '1.6' }}>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: '1.8rem', fontWeight: '600', margin: '0 0 1rem 0' }}>
                No Profile Data Found
              </h3>
              <p style={{ fontSize: '1.1rem', color: 'rgba(255, 255, 255, 0.8)', margin: '0 0 2rem 0', lineHeight: '1.6' }}>
                It looks like you haven't completed your profile yet. Please complete your profile to see your data here.
              </p>
              <button 
                style={{
                  padding: '1rem 2rem',
